...
public class WordMedian extends Configured implements Tool {
	...
	/**
	 * Maps words from line of text into a key-value pair; the length of the word as
	...
	/**
	 * This is a standard program to read and find a median value based on a file of
	 * word counts such as: 1 456, 2 132, 3 56... Where the first values are the
	 * word lengths and the following values are the number of times that words of
	 * that length appear.
	 * 
	 * @param path
