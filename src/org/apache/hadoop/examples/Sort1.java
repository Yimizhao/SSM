 ...
 */
public class Sort1<K,V> extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    Class<? extends Writable> outputValueClass = IntWritable.class;
  ...
  public static void main(String[] args) throws Exception {
	  args = new String[] { "hdfs://192.168.83.244:50040/user/cxd/inputSequencefile",
		"hdfs://192.168.83.244:50040/user/cxd/output" };
    int res = ToolRunner.run(new Configuration(), new Sort1(), args);
    System.exit(res);
  }
