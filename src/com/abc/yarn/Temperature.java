...
public class Temperature {
	 ...
	 * Reducer的输入数据的Value，这里是每行文字中的“气温” KeyOut Reducer的输出数据的Key，这里是不重复的“年份” ValueOut
	 * Reducer的输出数据的Value，这里是这一年中的“最高气温”
	 */
...
//		String dst = "hdfs://localhost:9000/intput.txt";
		String dst = "hdfs://192.168.83.244:50040/user/cxd/input";
		// 输出路径，必须是不存在的，空文件加也不行。
//		String dstOut = "hdfs://localhost:9000/output";
		String dstOut = "hdfs://192.168.83.244:50040/user/cxd/output";
